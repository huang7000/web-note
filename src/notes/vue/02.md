...
:::snippet demo 示例组件 hv-code-snippet
...
<template>
  <div class="hv-code-snippet">
    <div class="hv-code-snippet--demo">
...
Vue.component("hv-code-snippet", KvCodeSnippet);
Vue.component("hv-hello-world", KvHelloWorld);
