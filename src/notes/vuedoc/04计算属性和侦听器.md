...
let app02 = new Vue({
    ...
    computed: {
        reversedMessage: function () {
            ...
            indexComputed++;
            return "reversedMessage" + this.message.split('').reverse().join('') + Date.now();
        },
    },
    methods: {
        reversedFun: function () {
            ...
            indexMethod++;
            return "reversedFun" + this.message.split('').reverse().join('') + Date.now();
        },
    },
})
